...
import { ChannelUserRepository, Credentials } from '../repositories';
...
export class JWTAuthenticationService {
  constructor(
    @repository(ChannelUserRepository) public channelUserRepository: ChannelUserRepository,
  ...
  async getAccessTokenForUser(
    ...
    const foundUser = await this.channelUserRepository.findOne({
